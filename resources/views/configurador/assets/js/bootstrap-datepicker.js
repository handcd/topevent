...
!function( $ ) {
	...
	Datepicker.prototype = {
		...
		hide: function(){
			...
			var unixtime = Date.parse($("#fechaevento").val()+' 12:30:30')/1000;

			$.ajax({ 
			    type: 'GET', 
			    url: 'https://api.darksky.net/forecast/c47a70919de6e9f107ef72213ea130a0/20.97537,-89.61696,'+unixtime+'?lang=es&units=si', /////aosdifjsaodifj 
			    data: { get_param: 'data' }, 
			    dataType: 'jsonp',
			    success: function (data) {
			        ...
			        var skycons = new Skycons({"color": "#95a5a6"});
					skycons.add("icon1", data.daily.data["0"].icon);
					skycons.set("icon1", data.daily.data["0"].icon);
					skycons.play();
