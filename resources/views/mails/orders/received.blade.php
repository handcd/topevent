...
<head>
  ...
  <title>¡Tu orden ha sido recibida! | WIT Planner</title>
  <style type="text/css">
  body {
...
<body paddingwidth="0" paddingheight="0" bgcolor="#d1d3d4"  style="padding-top: 0; padding-bottom: 0; padding-top: 0; padding-bottom: 0; background-repeat: repeat; width: 100% !important; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;" offset="0" toppadding="0" leftpadding="0">
  ...
  <tbody>
    <tr>
      <td valign="top" width="60"><img src="{{ asset('mails/logo.png') }}" alt="Logo" title="Logo" width="120" height="60" data-max-width="140"></td>
...
<!-- =============== START BODY =============== -->
  ...
  <tbody>
    ...
    <tr>
      <td style="border: 2px solid rgba(63, 171, 216, 0.36); border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
    ...
    <tr>
      <td class="specbundle"><div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: left;'>
                              <h2 style="font-size: 20px;">¿Quiénes somos?</h2>
                              <br>
                              <p>La agencia en donde creamos, diseñamos, desarrollamos y operamos eventos en donde disfrutamos todos, tú porque es tu fiesta, y nosotros ¡porque nos encanta lo que hacemos!, desde la visualización, hasta el cierre.
                              </p>
                              <br><br>
                              <a target='_blank' href="#" class='link2' style='color:#ffffff'>Nosotros</a>
                              <br>
                            </div>
                          </div></td>
      ...
      <td class="specbundle"><div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: left;'>
                              <h2 style="font-size: 20px;">¡Gracias!</h2>
                              <br>
                              <p>¡Gracias por permitirnos tener la posibilidad de crear juntos esa celebración especial, y más que eso, darle ese toque diferente que hará que sea toda una experiencia!
                              </p>
                              <br><br>
                              <a target='_blank' href="#" class='link2' style='color:#ffffff'>Conoce más</a>
                              <br>
                            </div>
                          </div></td>
    </tr>
      ...
      <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                      ...
                      <tr>
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="font-size: 20px;">Aún más...</h2>
                              <br>
    ...
    <tr>
      <td class="specbundle" valign="top" width="142" align="center"><div class='contentEditableContainer contentImageEditable'>
                      <div class='contentEditable'>
                        <img src="{{ asset('mails/side.png') }}" alt="side image" width='142' height='142' data-default="placeholder" border="0">
                      </div>
                    </div></td>
...
@else
  ...
  <tbody>
    <tr>
      ...
      <td class="specbundle" valign="top" width="142" align="center"><div class='contentEditableContainer contentImageEditable'>
                      <div class='contentEditable'>
                        <img src="{{ asset('mails/side2.png') }}" alt="side image" width='142' height='142' data-default="placeholder" border="0">
                      </div>
                    </div></td>
    </tr>
  </tbody>
...
@endif
  ...
  <tbody>
    <tr>
      <td class="specbundle" valign="top" width="142" align="center"><div class='contentEditableContainer contentImageEditable'>
                      <div class='contentEditable'>
                        <img src="{{ asset('mails/side3.png') }}" alt="side image" width='142' height='142' data-default="placeholder" border="0">
                      </div>
                    </div></td>
      <td width="20" valign="top" class="spechide"></td>
      <td class="specbundle"><table width="100%" cellpadding="0" cellspacing="0" align="center">
                      ...
                      <tr>
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: left;'>
                              <h2 style='font-size:16px;'>¡Tu orden está segura!</h2>
                              <br>
                              <p>Ofrecemos una completa discreción y profesionalismo para organizar tu evento. Todos los detalles están protegidos por nuestra política de privacidad.</p>
                              <br>
                              <a target='_blank' href="#" class='link4' style='color:#27A1E5;' >Consultar Política de Privacidad</a>
                            </div>
                          </div>
                        </td>
                      </tr>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                              <p>
                              Enviado por <a href="mailto:contacto@witplanner.com.mx">contacto@witplanner.com.mx</a> <br/>
